    ...
    do
    {
        ...
        switch (abfrage)
        {
            ...
            case '5':
            	...
            	{
            		unsigned int matNr;
            		std::cout<<"Bitte die Matrikelnummer vom Studenten eingeben, der exmatrikuliert werden soll: "<<std::endl;
            		std::cin>>matNr;

            		ListenElement* gesucht = studentenListe.sucheMatNr(matNr);
            		...
            		else
            		{
            			...
            			gesucht->getData().ausgabe();

            			if(gesucht->getData().getMatNr() == studentenListe.dataFront().getMatNr()) //gesuchter Student ist am Anfang der Liste
            			{
            				studentenListe.popFront();
            			}
            			else if(gesucht->getData().getMatNr() == studentenListe.dataBack().getMatNr()) //gesuchter Student ist am Ende der Liste
            			{
						...
						{
            				studentenListe.popElement(gesucht);
						}
            		}
